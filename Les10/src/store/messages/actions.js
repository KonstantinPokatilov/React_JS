import { DataSnapshot, onValue, push } from "firebase/database";
import { getMsgsListRefById, getMsgsRefById, msgsRef } from "../../service/firebase";
...
export const addMsgsWithFb = (newMsg, chatId) => () => {
